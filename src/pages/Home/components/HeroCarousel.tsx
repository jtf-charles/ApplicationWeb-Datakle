...
const slides: Slide[] = [
  ...
  },
  {
    image: hero3,
    eyebrow: "SERVICES",
    title: "Exploitation données, marketing numériques et coaching.",
    lead: "Analyse de données, évaluation d'impact, cybermétrie et accompagnement personnalisé",
        ...
        >
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-3 md:gap-4">
            <Link
              ...
              className="btn btn--primary btn-pill nexa-bold"
            >
            ...
            {slides[index].secondary && (
              <Link
                ...
                className="btn btn--secondary btn-pill nexa-bold"
              >
