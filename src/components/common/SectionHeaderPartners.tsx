...
export default function SectionHeaderPartners({
  title,
  subtitle,
  ctaLabel,
  ctaTo,
  ...
  return (
    <div className={`mx-auto max-w-6xl xl:max-w-[76rem] ${className}`}>
      <section className="header-p header-simple-pad header-simple-d" >
        ...
        {subtitle && <p className="header-sub-simple mt-3">{subtitle}</p>}
